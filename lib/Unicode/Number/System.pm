...
our %NS_STR_TO_ISO_15924 = (
	...
	Chinese_Counting_Rod_Early         => 'Zyyy', # Common
	Chinese_Counting_Rod_Late          => 'Zyyy', # Common
	Chinese_Counting_Rod_Early_No_Zero => 'Zyyy', # Common
	Chinese_Counting_Rod_Late_No_Zero  => 'Zyyy', # Common
	Chinese_Legal_Simplified           => 'Hani', # Han
	Chinese_Legal_Traditional          => 'Hani', # Han
	Chinese_Regular_Simplified         => 'Hani', # Han
	Chinese_Regular_Traditional        => 'Hani', # Han
	Chinese_Regular_Place              => 'Hani', # Han
	...
	Japanese_Regular_Simplified        => 'Hani', # Han
	Japanese_Regular_Traditional       => 'Hani', # Han
	Japanese_Legal_Simplified          => 'Hani', # Han
	Japanese_Legal_Traditional         => 'Hani', # Han
	Japanese_Western_Mixed             => 'Hani', # Han
	...
	Mandarin_Legal_Simplified          => 'Hani', # Han
	Mandarin_Legal_Traditional         => 'Hani', # Han
	Mandarin_Regular_Simplified        => 'Hani', # Han
	Mandarin_Regular_Traditional       => 'Hani', # Han
